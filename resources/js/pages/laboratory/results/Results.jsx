...
const Results = () => {
  ...
  useEffect(() => {
    document.title = `Lab Results Entry - ${window.APP_NAME}`;
  }, []);
  ...
  const completedTests = (item) =>
    item.tests?.filter((t) => t.status === "Completed").length || 0;
  ...
  return (
    ...
    >
      <Card square variant="outlined">
        <PageHeader
          title="Results Entry"
          subtitle="Requests awaiting results (samples collected)"
          trailing={
                    ...
                    <Stack direction="row" spacing={1} flexWrap="wrap" alignItems="center" useFlexGap>
                      <Stack flexGrow={1}>
                        ...
                        <Typography variant="body2" color="text.secondary">
                          ...
                          {completedTests(item)}/{item.tests?.length || 0} results entered
                        </Typography>
                      </Stack>
                      <Chip
                      ...
                      <Button
                        ...
                        onClick={() => navigate(`/laboratory/requests/${item.id}`)}
                      >
                        Enter Results
                      </Button>
                      <Tooltip title="View">
